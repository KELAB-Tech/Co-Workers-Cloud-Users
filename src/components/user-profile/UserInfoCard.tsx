...
export default function UserInfoCard({ profile, onUpdate }: Props) {
  ...
  // ✅ Solo los campos que el backend acepta
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              ...
              <InfoItem label="Tipo de actor" value={ACTOR_LABELS[profile.actorType] ?? profile.actorType} />
              <InfoItem label="Tipo de persona" value={TIPO_PERSONA_LABELS[profile.tipoPersona] ?? profile.tipoPersona} />
              <InfoItem
                label="Miembro desde"
                value={
                  profile.createdAt
